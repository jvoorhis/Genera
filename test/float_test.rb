...
class FloatTest < Test::Unit::TestCase
  ...
  def test_addition
    ...
    sum = lhs + rhs
    assert_kind_of Genera::Float, sum
  ...
  def test_subtraction
    ...
    rhs = Genera.Float(2.0)
    difference = lhs - rhs
    assert_kind_of Genera::Float, difference
  ...
  def test_multiplication
    ...
    rhs = Genera.Float(2.0)
    product = lhs * rhs
    assert_kind_of Genera::Float, product
  ...
  def test_division
    ...
    rhs = Genera.Float(2.0)
    quotient = lhs / rhs
    assert_kind_of Genera::Float, quotient
  ...
  def test_negation
    flt = Genera.Float(1.0)
    neg = -flt
    assert_kind_of Genera::Float, neg
  ...
  def test_modulo
    ...
    rhs = Genera.Float(2.0)
    mod = lhs % rhs
    assert_kind_of Genera::Float, mod
  ...
  def test_exponentiaiton
    ...
    rhs = Genera.Float(2.0)
    pow = lhs ** rhs
    assert_kind_of Genera::Float, pow
  ...
  def test_abs
    flt = Genera.Float(1.0)
    abs = flt.abs
    assert_kind_of Genera::Float, abs
